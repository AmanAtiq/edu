...
const PricingCard = ({
  ...
  <Card className={`h-full flex flex-col border-2 ${isPopular ? "border-[#2366c9] shadow-xl md:scale-105 z-10" : "border-blue-100 shadow-lg"}`}>
    {isPopular && <div className="bg-[#2366c9] text-white text-center py-1.5 text-xs font-bold uppercase tracking-widest">Most Popular</div>}
    ...
    <CardFooter className="p-8 pt-0">
      <Button className={`w-full h-12 text-sm font-bold rounded-xl ${isPopular ? "bg-[#2366c9]" : "bg-[#1e1b4b]"}`}>{ctaText}</Button>
    </CardFooter>
  </Card>
);
  ...
  return (
    <div className="bg-white rounded-3xl shadow-2xl border border-blue-100 overflow-hidden text-slate-900 grid lg:grid-cols-2">
      <div className="p-8 md:p-12 bg-slate-50">
        <h3 className="text-2xl font-bold mb-8 flex items-center gap-3 text-[#1e1b4b]"><Calculator className="text-[#2366c9]" /> Cost Perspective</h3>
        <div className="space-y-10">
          <div>
            <label className="block text-sm font-bold text-slate-700 mb-6 uppercase tracking-wider">Number of Subjects: <span className="text-[#2366c9] text-xl ml-2">{subjects}</span></label>
      ...
      <div className="p-8 md:p-12 flex flex-col justify-center items-center text-center bg-gradient-to-b from-emerald-50/40 via-white to-white border-t lg:border-t-0 lg:border-l border-emerald-100/60">
        ...
        <Button className="mt-10 w-full h-14 text-lg font-bold bg-[#2366c9] shadow-xl rounded-2xl text-white">Secure This Pricing</Button>
      </div>
    </div>
  );
};
    ...
    <Card className="border-blue-100 shadow-xl">
      ...
      <CardContent className="grid lg:grid-cols-2 gap-8">
        <div className="space-y-6">
          <div>
            <label className="block text-xs font-bold uppercase tracking-wider text-slate-600 mb-2">Current Support Type</label>
          ...
          <div>
            <label className="block text-xs font-bold uppercase tracking-wider text-slate-600 mb-2">Subjects</label>
          ...
          <div>
            <label className="block text-xs font-bold uppercase tracking-wider text-slate-600 mb-2">Time Horizon</label>
          ...
          <div>
            <label className="block text-xs font-bold uppercase tracking-wider text-slate-600 mb-2">Desired EduMeUp Program</label>
        ...
        <div className="bg-slate-50 rounded-2xl p-6 border border-blue-100 flex flex-col justify-center">
          <div className="space-y-3">
            ...
            <div className="border-t border-blue-100 pt-3 flex justify-between items-center">
              <span className="text-sm font-bold text-slate-700">Approximate difference</span>
    ...
    <Layout>
      <section className="pt-28 pb-24 bg-[#1e1b4b] text-white relative overflow-hidden text-center">
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="relative z-10">
            ...
            <p className="text-2xl text-blue-300 font-bold mb-4">Structured Support. Affordable Access.</p>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/programs"><Button size="lg" className="bg-[#2366c9] hover:bg-[#1d57ac] h-14 px-10 rounded-2xl font-bold text-white">Browse Programs <ArrowRight className="h-4 w-4 ml-2" /></Button></Link>
              <InquiryDialog defaultType="diagnostic" title="Free Diagnostic" trigger={<Button size="lg" variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-[#1e1b4b] h-14 px-10 rounded-2xl font-bold">Take Free Diagnostic</Button>} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-[#1e1b4b] mb-6">Why Our Prices Are Lower Than Traditional Tutoring</h2>
      ...
      <section className="py-20 bg-blue-50/60">
        <div className="max-w-6xl mx-auto px-6 text-center mb-12">
          <h2 className="text-4xl font-bold text-[#1e1b4b] mb-3">Core Programs</h2>
        ...
        <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-8">
          <Card className="border-blue-100">
            ...
            <CardContent className="space-y-3">
              ...
              <p className="text-sm font-bold text-[#1e1b4b] pt-2">No hidden platform charges.</p>
            </CardContent>
          </Card>
      ...
      <section className="py-20 bg-blue-50/60">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-[#1e1b4b] mb-3">How We Compare (Calm & Balanced)</h2>
            ...
            {[
              ...
              <Card key={block.title} className="border-blue-100 h-full">
                ...
                <CardContent className="space-y-4 text-sm">
                  <div>
                    <p className="font-bold text-[#2366c9] mb-2">Pros</p>
                  ...
                  {block.considerations.length > 0 && (
                    <div>
                      <p className="font-bold text-[#1e1b4b] mb-2">Considerations</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-10">
            <h2 className="text-4xl font-bold text-[#1e1b4b] mb-3">How EduMeUp Differs from Traditional Support Models</h2>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-[#1e1b4b] text-white">
                  <th className="text-left p-4 font-bold">Traditional Tutoring Model</th>
                  <th className="text-left p-4 font-bold">EduMeUp Structured Platform</th>
                </tr>
              </thead>
              <tbody>
                {[
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-8">
          <Card className="border-blue-100">
            ...
            <CardContent className="space-y-4 text-sm text-slate-700 font-medium">
              <p><span className="font-bold text-[#1e1b4b]">30-Day Money-Back Guarantee:</span> If you&apos;re not satisfied within the first 30 days, request refund via email. Full refund processed within 5–7 business days.</p>
              <p><span className="font-bold text-[#1e1b4b]">Performance Support Guarantee (Selected Programs):</span> If a student completes ≥80% of assigned coursework and assessments and does not reach agreed benchmark levels, additional remediation support is provided at no extra cost. Clear compliance terms apply.</p>
              <p className="font-bold text-[#1e1b4b]">We stand behind structured effort.</p>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4 text-sm">
              {[
                ...
                <div key={question} className="p-4 rounded-xl bg-blue-50/50 border border-blue-100">
                  <p className="font-bold text-[#1e1b4b]">{question}</p>
      ...
      <section className="py-20 bg-[#1e1b4b] text-white relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/programs"><Button size="lg" className="bg-[#2366c9] hover:bg-[#1d57ac] h-14 px-10 rounded-2xl font-bold text-white">Browse Programs <ArrowRight className="h-4 w-4 ml-2" /></Button></Link>
            <InquiryDialog defaultType="consultation" title="Schedule Consultation" trigger={<Button size="lg" variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-[#1e1b4b] h-14 px-10 rounded-2xl font-bold">Schedule Consultation</Button>} />
          </div>
        </div>
      </section>
    </Layout>
